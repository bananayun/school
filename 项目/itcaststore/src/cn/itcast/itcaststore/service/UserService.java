		...
		try {
			...
			String emailMsg = "感谢您注册网上书城，点击"
					...
					+ user.getActiveCode() + "'>&nbsp;激活&nbsp;</a>后使用。"
							+ "<br />为保障您的账户安全，请在24小时内完成激活操作。" + addr.getHostName()
							+ "<br /><br />" + "如果邮箱没有在该电脑登录，请复制以下链接到浏览器即可激活用户"
							+ "http://localhost:8080/itcaststore/activeUser?activeCode=" + user.getActiveCode();
			System.out.println("如果邮箱没有在该电脑登录，请复制以下链接到浏览器即可激活用户\n"
					+ "http://localhost:8080/itcaststore/activeUser?activeCode=" + user.getActiveCode());
