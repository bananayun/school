...
<title>Banana商城-个人中心</title>
<script type="text/javascript">
	function deleteAddr(id){
		var res = confirm("是否删除");
		if(res==true){
			window.location.href="userAddressDel?id="+id;
		}
	}
	function defaultAddr(id){
		var res = confirm("是否设为默认");
		if(res==true){
			window.location.href="userAddressDef?id="+id;
...
<div id="dingdanxiangqing_body">
    <div id="dingdanxiangqing_body_big">
        <div id="big_left">
               ...
               <a id="big_left_a" href="">我的订单</a><br/>
							...
							<div class="modal fade" tabindex="-1" role="dialog" id="myModal${address.id}">
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
									...
									<form action="useraddressupdate" method="post" class="form-horizontal">
		...
		<div class="container" style="width:960px;">
			<form action="userAddressAdd" method="post" class="form-horizontal">
				...
				<div class="form-group col-md-12">
					...
					<a href="${pageContext.request.contextPath}/getCart" class="btn btn-primary">返回购物车</a> 
				</div>
			</form>
	      </div>
       </div>
