...
<body>			
 <div id="top">
    	<div id="topdiv">
            <span>
                <a href="index.jsp" id="a_top" target="_blank">Banana商城</a>
                <li>|</li>
                <a href="" id="a_top">Banana商城网页版</a>
                <li>|</li>
                <a href="feedback.jsp" id="a_top">问题反馈</a>
            </span>
            <span style="float:right">
                ...
                <c:if test="${empty user}">
                	<a href="${pageContext.request.contextPath}/login.jsp" id="shorpcar">购物车</a>
                </c:if>
                <c:if test="${not empty user }">
...
<table style="height:100px;width:86%" align="center">
	<tr>
	<td>
		<img id="logo" src="image/logo3.png" width="200px" height="60px"/>
	</td>
	<td>
